  ...
  return(
    ...
    <h2>Maiores campeões:</h2>
        ...
        <ul>
            ...
            <li>1962 foi o bi campeonato, ganharam dois títulos seguidos!</li>
            <li>Na edição de 1966 caíram na fase de grupos, mas em 1970 voltaram a ganhar, foram a primeira seleção a ganhar o tri da copa do mundo.</li>
            <li>Depois do tri, firam 24 anos em jejum de títulos mundiais, somente em 1994 eles ganharam o tetra nos pênaltis contra a Itália</li>
            <li>Após o fiasco que foi em 1998, em 2002 chegaram com tudo para poderem se redimir da decepção que foi em 98, em 2002 fomos campeões contra a poderosa da Alemanha.</li>
        </ul>
        <h3>Maiores artilheiros do torneio</h3>
        
            <li><strong>Miroslav Klose:</strong> 16 gols pela seleção alemã</li>
           <img className="userimg" src="./klose.webp"/>
            <li><strong>Ronaldo Fenômeno:</strong> 15 gols pela seleção brasileira</li>
           <img className="userimg" src="./ronaldo fenomeno.webp" />
            <li><strong>Gerd Müller:</strong> 14 gols pela seleção alemã</li>
            <img className="userimg" src="./muller2.jfif"/>
            <li><strong>Just Fontaine:</strong> 13 gols pela seleção francesa</li>
            <img className="userimg" src="./just.jpg" />
            <li><strong>Lionel Messi:</strong> 13 gols pela seleção argentina</li>
            <img className="userimg" src="./messi.webp"/>
            <li><strong>Kilyan Mbappé:</strong> 12 gols pela seleção francesa</li>
            <img className="userimg" src="./mbappe.webp"/>
            <li><strong>Pelé:</strong> 12 gols pela seleção brasileira</li>
           <img className="userimg" src="./pele3_0.jpg" />
            <li><strong>Jürgen Klinsmann:</strong> 11 gols pela seleção alemã</li>
           <img className="userimg" src="./jurgenklisman.jfif" />
            <li><strong>Sandor Kocsis:</strong> 11 gols pela seleção hungara</li>
            <img className="userimg" src="./koksis.jpg"/>
            <li><strong>Gabriel Batistuta</strong> 10 gols pela seleção argentina</li>
           <img className="userimg" src="./1998_BATISTUTA_SILVER_SHOE.webp" />
    ...
    <ol>
        ...
        <img className="userimg" src="./cruiff.jpg"/>
        <li><i>Michel Platini</i> 3 Bolas de Ouro (1983, 1984, & 1985)</li>
        <img className="userimg" src="./platini.jpg"/>
        <li><i>Marco Van Basten</i> 3 Bolas de Ouro (1988, 1989 & 1992)</li>
       <img className="userimg" src="./van_basten.webp"/>
